# GAME RULES:
A responsive and interactive Wordle-inspired game built with **React**. Guess the 5-letter word in 6 tries!
Colors guide your guesses—green means correct letter & spot, yellow means correct letter but wrong spot, and gray means it's not in the word at all.
...
Access the live game here: [**Play Now**]((https://scintillating-sable-bb226d.netlify.app/))  
